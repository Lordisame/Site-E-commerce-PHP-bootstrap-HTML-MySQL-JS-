        ...
        <div class = "container">
            ...
            <div class = "row g-0">
                ...
                <?php foreach($Produits as $produit):?>
                    <div id="rabache" class = "col-md-6 col-lg-4 col-xl-3 p-2 best">
                        <div class = "collection-img position-relative">
                            <img src = "images/<?= $produit->image?>" class = "w-100">
                        </div>
                        <div class = "text-center">
                            ...
                            <a href = "product.php?id=<?= $produit->id?>" class = "btn btn-primary mt-3">More Details</a>
